...
@objc open class PermissionScope: UIViewController, CLLocationManagerDelegate, UIGestureRecognizerDelegate, CBPeripheralManagerDelegate {
    ...
    */
    internal func allAuthorized(_ completion: (Bool) -> Void ) {
    ...
    **Deprecated** See issues #50 and #51.
    ...
    - parameter completion: Closure used to send the result of the check.
    */
    internal func requiredAuthorized(_ completion: (Bool) -> Void ) {
        getResultsForConfig{ results in
            let result = results.first(where: { $0.status != .authorized }).isNil
            completion(result)
        }
    ...
    */
    internal func permissionStyledButton(_ type: PermissionType) -> UIButton {
        ...
        case .locationAlways, .locationInUse:
            button.setTitle("Enable \(type.prettyDescription)".localized.uppercased(), for: UIControl.State())
        default:
    ...
    */
    internal func setButtonAuthorizedStyle(_ button: UIButton) {
    ...
    - parameter button: Permission button
    */
    internal func setButtonUnauthorizedStyle(_ button: UIButton) {
        button.layer.borderWidth = 0
    ...
    */
    internal func permissionStyledLabel(_ type: PermissionType) -> UILabel {
    ...
    */
    @objc internal func showingNotificationPermission() {
    ...
    */
    @objc internal func finishedShowingNotificationPermission () {
    ...
    */
    internal func showDeniedAlert(_ permission: PermissionType) {
    ...
    - parameter permission: Permission type.
    */
    internal func showDisabledAlert(_ permission: PermissionType) {
        // compile the results and pass them back if necessary
        if let onDisabledOrDenied = self.onDisabledOrDenied {
            self.getResultsForConfig({ results in
                onDisabledOrDenied(results)
    ...
    */
    @objc internal func appForegroundedAfterSettings() {
    ...
    */
    internal func statusForPermission(_ type: PermissionType, completion: statusRequestClosure) {
    ...
    */
    internal func getResultsForConfig(_ completionBlock: resultsForConfigClosure) {
